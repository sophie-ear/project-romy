...
class MicroKernel
{
    ...
    public function loadClass($class)
    {
        ...
        {
            // Le code a été changé ici pour rediriger l'user vers l'accueil si la page n'existe pas
            $flashBag = new FlashBag();
			$flashBag->add("La page que vous recherchez n'existe pas.");
            header('Location: http://'.$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].$_SERVER['SCRIPT_NAME']);
